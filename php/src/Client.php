...
namespace APIVerve\Fullyqualifieddomain;
...
/**
 * Client for the Fully Qualified Domain API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/fullyqualifieddomain?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/fullyqualifieddomain';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\FullyqualifieddomainClient] {$message}\n";
        }
    }
}
