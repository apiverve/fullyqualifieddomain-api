...
namespace APIVerve.API.FullyQualifiedDomain
{
    ...
    /// <summary>
    /// Client for the FullyQualifiedDomain API
    /// </summary>
    public class FullyQualifiedDomainAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/fullyqualifieddomain";
        ...
        public FullyQualifiedDomainAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public FullyQualifiedDomainAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public FullyQualifiedDomainAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, FullyQualifiedDomainQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(FullyQualifiedDomainQueryOptions options)
        {
        ...
        public ResponseObj Execute(FullyQualifiedDomainQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(FullyQualifiedDomainQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(FullyQualifiedDomainQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(FullyQualifiedDomainQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(FullyQualifiedDomainQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(FullyQualifiedDomainQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(FullyQualifiedDomainQueryOptions options)
        {
