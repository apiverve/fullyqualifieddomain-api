# Fully Qualified Domain Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:fullyqualifieddomain-api:1.1.14'
}
```
...
```java
import com.apiverve.fullyqualifieddomain.FullyQualifiedDomainAPIClient;
import com.apiverve.fullyqualifieddomain.APIResponse;
import com.apiverve.fullyqualifieddomain.APIException;

// Initialize the client
FullyQualifiedDomainAPIClient client = new FullyQualifiedDomainAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("ip", "199.30.24.0");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/fullyqualifieddomain](https://docs.apiverve.com/ref/fullyqualifieddomain)
...
- **Documentation:** [https://docs.apiverve.com/ref/fullyqualifieddomain](https://docs.apiverve.com/ref/fullyqualifieddomain)
- **Issues:** [GitHub Issues](https://github.com/apiverve/fullyqualifieddomain-api/issues)
